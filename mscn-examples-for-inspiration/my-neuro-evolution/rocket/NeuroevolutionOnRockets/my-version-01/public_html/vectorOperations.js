...
function rotation(vector, angle){
  return[vector[0]*Math.cos(angle*Math.PI/180) - vector[1]*Math.sin(angle*Math.PI/180), vector[0]*Math.sin(angle*Math.PI/180) + vector[1]*Math.cos(angle*Math.PI/180)]
}
