...
class Ship {
    constructor(brain){
		...
		//this.pos = new Vector2(planets[0].pos.add(new Vector2(-260, -260.0)));
    ...
    calculateScore() {
		...
		//this.score = averageEccentricity;
		this.score = averageEccentricity; // * 1 + (1/this.ticksAlive) * 100;
		this.score += this.outsideScreen() ? 100 : 0;
		//this.score += this.crashlandsOnPlanet() ? 0 : 100;
