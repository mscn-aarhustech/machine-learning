...
let gaParams = {
    ...
    elitismRate : 0.2,  // Fraction of fittest individuals that will be cloned to next generation.
...
function evaluate() {
    ...
    if (ships.length === 0) {
        ...
        //obstacles[0].pos = new Vector2(200 + Math.random() * (width - 400 ), 200 + Math.random() * (height - 400 ));
