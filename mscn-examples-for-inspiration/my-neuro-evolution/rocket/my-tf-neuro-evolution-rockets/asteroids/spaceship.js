class Spaceship {
	...
	think() {
		...
		inputs[0] = checkpoints[this.currentCheckpoint].x - this.posx;
		inputs[1] = checkpoints[this.currentCheckpoint].y - this.posy;
		...
		// inputs[0] = checkpoints[this.currentCheckpoint].x;
		// inputs[1] = checkpoints[this.currentCheckpoint].y;
		// angle to checkpoint
		//inputs[0] = Math.atan2(checkpoints[this.currentCheckpoint].y - this.posy, checkpoints[this.currentCheckpoint].x - this.posx);
		// distance to checkpoint
		//inputs[1] = dist(this.posx, this.posy, checkpoints[this.currentCheckpoint].x, checkpoints[this.currentCheckpoint].y);
		// inputs[2] = this.posx;
		// inputs[3] = this.posy;
		// inputs[2] = checkpoints[this.currentCheckpoint].x - this.posx;
		// inputs[3] = checkpoints[this.currentCheckpoint].y - this.posy;
		// inputs[2] = this.velx;
		// inputs[3] = this.vely;
		// vel angle
		//inputs[2] = Math.atan2(this.vely, this.velx);
	...
	move() {
		...
		// this.x += cos(this.angle) * this.thrust;
		// this.y += sin(this.angle) * this.thrust;
