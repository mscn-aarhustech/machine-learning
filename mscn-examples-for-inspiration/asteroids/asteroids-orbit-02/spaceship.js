class Spaceship {
	constructor(brain) {
		...
		this.velx = 0; //circularOrbitVelocityVector(this, G)[0];
		this.vely = 0; //circularOrbitVelocityVector(this, G)[1];
		this.angle = 0;
		...
		if (brain) {
			...
			this.brain = new NeuralNetwork(7, 32, 3);
		}
	}
	...
	think() {
		...
		inputs[0] = this.posx - planets[0].posx;
		inputs[1] = this.posy - planets[0].posy;
	...
	draw() {
		...
		// Orbital elements
		//let semiMajor = semiMajorAxis(this, planets[0], G);
		//console.log(semiMajor);

		// let eccVector = eccentricityVector(this, planets[0], G);
		// console.log(eccVector);

		// let ecc = eccentricity(this, planets[0], G);
		// console.log(ecc);
	...
	move() {
		...
		this.eccentricity = eccentricity(this, planets[0], G);
		this.averageEccentricity += this.eccentricity;
